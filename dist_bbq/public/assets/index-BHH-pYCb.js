import{B as S,N as m,H as A,J as V,c as p,o as g,a as h,d as y,s as z,e as I,m as s,t as k,X as f,Z as c,r as C,F as K,y as $,f as x,_ as D,w as R}from"./index-CZ1Dq0ER.js";import{R as w,f as B}from"./index-CPpckpSh.js";import{b as O}from"./index-Cfinogjs.js";var E=`
    .p-togglebutton {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
...
`,X={root:function(e){var n=e.props,l=e.instance;return["p-selectbutton p-component",{"p-invalid":l.$invalid,"p-selectbutton-fluid":n.fluid}]}},Y=S.extend({name:"selectbutton",style:W,classes:X}),Z={name:"BaseSelectButton",extends:O,props:{options:Array,optionLabel:null,optionValue:null,optionDisabled:null,multiple:Boolean,allowEmpty:{type:Boolean,default:!0},dataKey:null,ariaLabelledby:{type:String,default:null},size:{type:String,default:null},fluid:{type:Boolean,default:null}},style:Y,provide:function(){return{$pcSelectButton:this,$parentInstance:this}}};function G(t,e){var n=typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(!n){if(Array.isArray(t)||(n=P(t))||e){n&&(t=n);var l=0,a=function(){};return{s:a,n:function(){return l>=t.length?{done:!0}:{done:!1,value:t[l++]}},e:function(d){throw d},f:a}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
