import{v as Lt,B as yt,x as It,y as zt,f as d,p as r,q as Y,i as k,z as vt,A as U,C as wt,h as n,t as f,n as rt,r as D,g as y,F as J,l as G,k as u,a as w,j as z,D as Pt,u as gt,s as kt,m as at,e as ee,E as pe,G as fe,c as ft,w as ve,R as ae,H as Rt,I as he,J as Vt,K as be,L as St,M as me,N as Ft,O as Nt,P as At,Q as ge,S as ye,T as Bt,o as se,b as _e,U as we,V as ke,d as $e}from"./index-BCK9oFSF.js";import{s as $t,a as ne}from"./index-CkAYU2Yo.js";import{s as K,a as oe}from"./index-Bo7pAELv.js";import{D as F,c as Z,s as Kt,a as xe}from"./index-DqfPbZ7e.js";import{_ as Dt,b as Wt,c as Ht,a as Ut,s as Qt}from"./_plugin-vue_export-helper-CCkp5ae1.js";import{s as Te}from"./index-BE9kwXiG.js";import{s as Jt,a as Ie}from"./index-CChhq3IH.js";import{s as De}from"./index-D9f92eBE.js";import{s as Xt}from"./index-D3Wm9zjV.js";import"./index-CiTqqPOh.js";var Ce=Lt`
    .p-tag {
        display: inline-flex;
        align-items: center;
...
`,Ee={root:function(e){var o=e.props;return["p-avatar p-component",{"p-avatar-image":o.image!=null,"p-avatar-circle":o.shape==="circle","p-avatar-lg":o.size==="large","p-avatar-xl":o.size==="xlarge"}]},label:"p-avatar-label",icon:"p-avatar-icon"},Re=yt.extend({name:"avatar",style:Oe,classes:Ee}),Ve={name:"BaseAvatar",extends:It,props:{label:{type:String,default:null},icon:{type:String,default:null},image:{type:String,default:null},size:{type:String,default:"normal"},shape:{type:String,default:"square"},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:Re,provide:function(){return{$pcAvatar:this,$parentInstance:this}}};function Tt(t){"@babel/helpers - typeof";return Tt=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Tt(t)}function Yt(t,e,o){return(e=je(e))in t?Object.defineProperty(t,e,{value:o,enumerable:!0,configurable:!0,writable:!0}):t[e]=o,t}function je(t){var e=Me(t,"string");return Tt(e)=="symbol"?e:e+""}function Me(t,e){if(Tt(t)!="object"||!t)return t;var o=t[Symbol.toPrimitive];if(o!==void 0){var c=o.call(t,e);if(Tt(c)!="object")return c;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(t)}var ie={name:"Avatar",extends:Ve,inheritAttrs:!1,emits:["error"],methods:{onError:function(e){this.$emit("error",e)}},computed:{dataP:function(){return zt(Yt(Yt({},this.shape,this.shape),this.size,this.size))}}},Fe=["aria-labelledby","aria-label","data-p"],Ke=["data-p"],We=["data-p"],He=["src","alt","data-p"];function Ue(t,e,o,c,g,i){return r(),d("div",U({class:t.cx("root"),"aria-labelledby":t.ariaLabelledby,"aria-label":t.ariaLabel},t.ptmi("root"),{"data-p":i.dataP}),[vt(t.$slots,"default",{},function(){return[t.label?(r(),d("span",U({key:0,class:t.cx("label")},t.ptm("label"),{"data-p":i.dataP}),f(t.label),17,Ke)):t.$slots.icon?(r(),Y(wt(t.$slots.icon),{key:1,class:rt(t.cx("icon"))},null,8,["class"])):t.icon?(r(),d("span",U({key:2,class:[t.cx("icon"),t.icon]},t.ptm("icon"),{"data-p":i.dataP}),null,16,We)):t.image?(r(),d("img",U({key:3,src:t.image,alt:t.ariaLabel,onError:e[0]||(e[0]=function(){return i.onError&&i.onError.apply(i,arguments)})},t.ptm("image"),{"data-p":i.dataP}),null,16,He)):k("",!0)]})],16,Fe)}ie.render=Ue;const Qe={class:"grid"},Je={class:"flex flex-column"},Xe=["onClick"],Ye={class:"p-1 flex-shrink-0 w-7rem h-7rem flex align-items-center justify-content-center overflow-hidden"},Ge=["src","alt"],Ze={class:"flex flex-column justify-content-center"},ta={class:"font-bold"},ea={class:"flex flex-wrap gap-2"},aa={class:"flex gap-1 align-items-center"},sa={class:"text-color-secondary line2"},na={key:0,class:"text-xl font-bold text-primary"},oa={key:1,class:"flex align-items-center gap-1"},ia={class:"text-l font-bold text-color-secondary"},la={class:"text-sm line-through text-500"},ra={key:2,class:"flex gap-2 mr-2",id:"card-quantity"},ua={class:"w-2rem text-xl text-center"},ca={key:3,class:"flex gap-2 mr-2"},da={key:0,class:"m-2 mt-0"},pa={class:"flex flex-row justify-content-between align-content-center"},fa={class:"flex flex-column"},va={class:"text-l font-bold"},ha={key:0,class:"text-l font-bold text-color-secondary"},ba={key:1,class:"flex align-items-center gap-1"},ma={class:"text-l font-bold text-color-secondary"},ga={class:"text-sm line-through text-500"},ya={key:0,class:"flex ml-2 mr-2"},_a={class:"w-2rem text-xl text-center"},wa={key:1,class:"flex gap-2 mr-3 pt-2 pb-2"},ka={class:"max-w-5rem flex align-items-center"},$a={class:"font-bold whitespace-nowrap"},xa={class:"mb-2 flex justify-content-center"},Ta={class:"font-bold text-center"},Ia={class:"mb-2"},Da={class:"text-color-secondary m-0 line-height-3 line2 text-center"},Ca={class:"mb-2"},Sa={class:"flex justify-content-center"},Ba=["src","alt"],Pa={class:"flex align-items-center gap-2"},Na=["src","alt"],Aa={class:"flex align-items-center gap-3 ml-auto"},La={__name:"DishList",props:{updateCartItemCount:{type:Function,required:!0},rateDish:{type:Function,required:!0},likedItemsRef:Array,dislikedItemsRef:Array},setup(t){const e=F.dishes;let o={rated:!1,id:null,like:0,rate:0};function c(){var s;const a=w.currentPage.value,l=(s=a==null?void 0:a.data)==null?void 0:s.logoPath;return l?w.pathFormated(l):"/images/logo_logo.png"}const g=(a,l)=>{const s=e.value[a].quantity+l;s>=0&&(e.value[a].quantity=s,M.updateCartItemCount(l))},i=(a,l)=>{const s=F.dishDatas.value[a].quantity+l;s>=0&&(F.dishDatas.value[a].quantity=s,M.updateCartItemCount(l))},T=a=>F.dishDatas.value[a]?F.dishDatas.value[a].quantity:0,$=a=>{const l=F.dishDatas.value[a];if(l){if(!l.category){const s=e.value.find(q=>q.handle===l.handle);if(s&&s.limit)return O(s)}return O(l)}return!0},O=a=>{if(!W())return!1;const l=a.quantity;let s=3;if(a.price>0&&(s=9),a.limit){const q=a.id,_=W(),ot=(_.peopleType.adults+_.peopleType.children)*a.limit,pt=_.order.find(bt=>bt.dishid==q);let it=0;if(a.subitem)for(const bt of a.subitem){it+=T(bt);const Ct=_.order.find(qt=>qt.dishid==Q(bt));Ct&&(it+=Ct.quantity)}else it+=a.quantity,pt&&(it+=pt.quantity);return l>=s||ot&&it>=ot}return l>=s},V=a=>F.dishDatas.value[a]?!F.dishDatas.value[a].disable:!0,j=a=>F.dishDatas.value[a]?F.dishDatas.value[a].soldout:!1,N=a=>F.dishDatas.value[a]?w.getItemLocalValue(F.dishDatas.value[a],"subname"):"",Q=a=>F.dishDatas.value[a]?F.dishDatas.value[a].id:0,tt=a=>F.dishDatas.value[a]?F.dishDatas.value[a].price:10,B=a=>F.dishDatas.value[a]?F.dishDatas.value[a].dis_price:10,st=a=>{const l=F.dishDatas.value[a];return l&&l.discount?l.discount:0},P=a=>st(a)>0,C=a=>tt(a)>0?!P(a):!1,W=()=>w.getTableValue();function nt(){M.rateDish(o.id,o.like,o.rate,o.rated),o.id=null,o.like=0,o.rate=0,o.rated=!1}const ht=a=>{const l=M.likedItemsRef.indexOf(a);if(o.id=a.id,l!==-1)M.likedItemsRef.splice(l,1),o.like+=-1,o.rate+=-1,o.rated=!1;else{o.rated=!0,M.likedItemsRef.push(a);const s=M.dislikedItemsRef.indexOf(a);s!==-1?(M.dislikedItemsRef.splice(s,1),o.like+=1):(o.like+=1,o.rate+=1)}},dt=a=>{const l=M.dislikedItemsRef.indexOf(a);if(o.id=a.id,l!==-1)M.dislikedItemsRef.splice(l,1),o.rate+=-1,o.rated=!1;else{o.rated=!0,M.dislikedItemsRef.push(a);const s=M.likedItemsRef.indexOf(a);s!==-1?(M.likedItemsRef.splice(s,1),o.like+=-1):o.rate+=1}},M=t,lt=D(!1),X=D({}),v=a=>{lt.value=!0,X.value=a},m=a=>{a.target.src="/images/default.png"};function I(a){x(a.target,300)}function S(a){x(a.target,110)}function x(a,l){const s=a.naturalWidth,q=a.naturalHeight,_=Math.min(s,l),ot=_/s,pt=q*ot;a.style.width=`${_}px`,a.style.height=`${pt}px`}return(a,l)=>(r(),d(J,null,[n("div",Qe,[(r(!0),d(J,null,G(u(e),(s,q)=>(r(),d("div",{key:q,class:"col-12 sm:col-12 md:col-6 lg:col-4 border-round surface-section shadow-1 p-2"},[n("div",Je,[n("div",{class:rt(["flex flex-row",s.subitem?"":"flex-grow-1"]),onClick:_=>v(s)},[n("div",Ye,[n("img",{src:s.image,alt:s.name,class:"w-full h-full",style:{"object-fit":"cover"},onError:m,onLoad:S},null,40,Ge)]),n("div",Ze,[n("div",ta,f(u(w).getItemLocalValue(s,"name")),1),n("div",null,[n("div",ea,[n("div",aa,[(r(),d(J,null,G(5,_=>n("i",{key:_,class:rt(["pi invert-star",_<=Math.floor(s.likes/s.rates*5)?"pi-star-fill":_-.5<=s.likes/s.rates*5?"pi-star-half-fill":"pi-star"]),style:{color:"black"}},null,2)),64)),n("p",null,"("+f(s.rates?s.rates:0)+")",1)])])]),n("div",null,[n("p",sa,f(u(w).getItemLocalValue(s,"description")),1)])])],10,Xe),s.subitem===void 0?(r(),d("div",{key:0,class:rt(["flex ml-2 mr-2 mb-2",s.price>0?"justify-content-between":"justify-content-end"])},[!s.discount&&s.price>0?(r(),d("span",na,"€"+f(s.price),1)):k("",!0),s.discount?(r(),d("div",oa,[n("span",ia,"€"+f(s.dis_price),1),n("span",la,"€"+f(s.price),1),y(u(_t),{severity:"danger",value:"-"+s.discount+"%"},null,8,["value"])])):k("",!0),s.soldout?k("",!0):(r(),d("div",ra,[y(u(K),{icon:"pi pi-minus",rounded:"",disabled:s.quantity<=0,onClick:_=>g(q,-1),class:"w-2rem h-2rem"},null,8,["disabled","onClick"]),n("span",ua,f(s.quantity),1),y(u(K),{icon:"pi pi-plus",rounded:"",disabled:O(s),onClick:_=>g(q,1),class:"w-2rem h-2rem"},null,8,["disabled","onClick"])])),s.soldout?(r(),d("div",ca,[y(u(_t),{severity:"danger",value:a.$t("common.soldout")},null,8,["value"])])):k("",!0)],2)):k("",!0),s.subitem?(r(!0),d(J,{key:1},G(s.subitem,(_,ot)=>(r(),d(J,{key:"index"},[V(_)?(r(),d("div",da,[n("div",pa,[n("div",fa,[n("span",va,f(N(_)),1),C(_)?(r(),d("span",ha,"€"+f(tt(_)),1)):k("",!0),P(_)?(r(),d("div",ba,[n("span",ma,"€"+f(B(_)),1),n("span",ga,"€"+f(tt(_)),1),y(u(_t),{severity:"danger",value:"-"+st(_)+"%"},null,8,["value"])])):k("",!0)]),j(_)?k("",!0):(r(),d("div",ya,[y(u(K),{icon:"pi pi-minus",rounded:"",disabled:T(_)<=0,onClick:pt=>i(_,-1),class:"w-2rem h-2rem"},null,8,["disabled","onClick"]),n("span",_a,f(T(_)),1),y(u(K),{icon:"pi pi-plus",rounded:"",disabled:$(_),onClick:pt=>i(_,1),class:"w-2rem h-2rem"},null,8,["disabled","onClick"])])),j(_)?(r(),d("div",wa,[y(u(_t),{severity:"danger",value:a.$t("common.soldout")},null,8,["value"])])):k("",!0)])])):k("",!0)],64))),128)):k("",!0)])]))),128))]),y(u($t),{visible:lt.value,"onUpdate:visible":l[2]||(l[2]=s=>lt.value=s),modal:"",header:"dish",style:Pt([{width:"23rem"},{width:"80vw","max-width":"700px"}]),onHide:l[3]||(l[3]=s=>nt())},{header:z(()=>[n("div",ka,[y(u(ie),{image:c(),class:"w-full"},null,8,["image"])]),n("span",$a,f(a.$t("common.details")),1)]),default:z(()=>[n("div",xa,[n("span",Ta,f(u(w).getItemLocalValue(X.value,"name")),1)]),n("div",Ia,[n("span",Da,f(u(w).getItemLocalValue(X.value,"description")),1)]),n("div",Ca,[n("div",Sa,[n("img",{class:"w-full h-auto object-contain",src:X.value.image,alt:X.value.name,onError:m,onLoad:I},null,40,Ba)])]),n("div",Pa,[(r(!0),d(J,null,G(X.value.allergies,(s,q)=>(r(),d("img",{src:"images/"+s+".png",alt:s,class:"w-2rem h-2rem border-round flex-shrink-0",style:{"object-fit":"cover","min-width":"2rem"}},null,8,Na))),256)),n("div",Aa,[n("button",{onClick:l[0]||(l[0]=s=>ht(X.value)),class:"p-0 border-none bg-transparent cursor-pointer"},[n("i",{class:rt(["pi pi-thumbs-up text-xl",M.likedItemsRef.includes(X.value)?"text-green-500":"text-gray-400"])},null,2)]),n("button",{onClick:l[1]||(l[1]=s=>dt(X.value)),class:"p-0 border-none bg-transparent cursor-pointer"},[n("i",{class:rt(["pi pi-thumbs-down text-xl",M.dislikedItemsRef.includes(X.value)?"text-red-500":"text-gray-400"])},null,2)])])])]),_:1},8,["visible"])],64))}},za=Dt(La,[["__scopeId","data-v-e8933770"]]),qa={key:0,class:"text-3xl font-bold"},Oa={class:"flex flex-column gap-3 p-1"},Ea={key:0,class:"flex flex-column gap-1"},Ra={key:0,class:"m-0"},Va={key:0,class:"m-0"},ja={class:"flex justify-content-between gap-4 mt-1"},Ma={class:"flex align-items-center gap-2"},Fa=["src","alt"],Ka={class:"flex-grow-1 min-width-0 max-w-18rem"},Wa={class:"flex flex-column gap-1"},Ha={class:"flex align-items-center gap-2"},Ua={class:"text-xl font-bold line1 whitespace-nowrap overflow-hidden text-overflow-ellipsis",style:{"max-width":"20rem"}},Qa={class:"flex align-items-end gap-1"},Ja={key:0,class:"text-xl font-bold text-primary"},Xa={key:1,class:"text-xl font-bold text-primary"},Ya={key:2,class:"text-sm text-color-secondary"},Ga={key:0,class:"text-xs text-primary"},Za={class:"flex-shrink-0 flex flex-wrap justify-content-between align-items-center gap-1"},ts={class:"flex flex-wrap justify-content-between align-content-center"},es={class:"flex align-items-center gap-1"},as={class:"w-2rem text-center"},ss={key:1,class:"flex flex-column gap-2 mt-2"},ns={for:"in_label"},os={for:"in_label"},is={class:"bottom-0 left-0 mt-2"},ls={class:"text-2xl font-bold"},rs={class:"text-2xl font-bold text-primary pl-2"},us={class:"flex justify-content-between"},cs={__name:"Cart",props:{updateCartItemCount:{type:Function,required:!0},checkout:{type:Function,required:!0},isTakeaway:Boolean},setup(t,{expose:e}){const o=ee(),{t:c}=gt(),g=Z.cartDishs;w.freeCounts;const i=D([]),T=D(),$=D(),O=D(!1),V=D(!1),j=D(!0),N=D(""),Q=D("");function tt(a,l){let s="";return a.forEach(q=>{s=s+c(`${l}Data.ingredients.${q.id}`)+" / "}),s}function B(a,l,s){const q=w.customDishAPI.getCustomDishByName(a);if(q){const _=q.types[l].typeName;return c(`${s}Data.${_}`)}else return null}const st=(a,l)=>{const s=i.value[a].quantity+l;s>=0&&(i.value[a].quantity=s,nt.updateCartItemCount(l))};function P(a){a&&T.value&&(T.value.dishNote=$.value?$.value:void 0),V.value=!1}function C(){$.value&&($.value=void 0),T.value&&(T.value=void 0)}function W(a){T.value=a,$.value=T.value.dishNote?T.value.dishNote:void 0,V.value=!0}const nt=t;e({showDishList:a=>{O.value=!0,i.value.length=0;for(let l=0;l<a.length;l++)i.value.push(a[l]);j.value=i.value.length==0&&g.length==0}});function dt(a){switch(a){case"Bibimbap":return"customDishBibimbap";case"Sushi Aleatória®":return"customDishSushiBox";case"MY BOX":return"customDishMyBox";default:return"Unexpected"}}function M(a){Z.removeItem(a)}function lt(){nt.isTakeaway?X():v()}function X(){const a=[];g.value.forEach(l=>{a.push(l)}),i.value.forEach(l=>{l.quantity>0&&a.push(l)}),a.length<=0?at.show_warn(c("notification.select_at_least_one")):(O.value=!1,o.push({path:"/paymentPage"}))}function v(){nt.checkout({name:N.value,note:Q.value})&&(O.value=!1),g.value.forEach(a=>{a.dishNote=void 0}),i.value.forEach(a=>{a.dishNote=void 0}),Q.value="",localStorage.removeItem("order_cartDishs"),localStorage.removeItem("order_dishDatas")}function m(a){return a.subname!=""&&a.subname!="Default Title"?a.name+" "+a.subname:a.name}function I(){let a=0;return g.value.forEach(l=>{a+=l.dis_price?l.dis_price*l.count:l.price*l.count}),i.value.forEach(l=>{a+=l.dis_price?l.dis_price*l.quantity:l.price*l.quantity}),"€"+a.toFixed(2)}const S=a=>{a.target.src="/images/default.png"},x=a=>{const l=a.quantity;let s=3;return a.price>0&&(s=9),l>=s};return(a,l)=>(r(),d(J,null,[y(u($t),{class:"bg-primary-reverse text-sm md:text-lg lg:text-xl",visible:O.value,"onUpdate:visible":l[2]||(l[2]=s=>O.value=s),modal:"",header:a.$t("common.cart"),style:Pt([{backgroundColor:"rgba(250, 250, 250, 1)",height:"100%",minWidth:"24rem"},{width:"80vw","max-width":"700px"}]),dismissableMask:!0},{footer:z(()=>[n("div",is,[n("span",ls,f(a.$t("common.total"))+": ",1),n("span",rs,f(I()),1),y(u(K),{icon:t.isTakeaway?"pi pi-wallet":"pi pi-plus",class:"p-button-success p-button-rounded ml-3",onClick:lt,label:t.isTakeaway?u(c)("common.pay"):u(c)("common.send")},null,8,["icon","label"])])]),default:z(()=>[j.value?(r(),d("h2",qa,"Cart is empty.")):k("",!0),n("div",Oa,[(r(!0),d(J,null,G(u(g),(s,q)=>(r(),Y(u(Te),{style:{overflow:"hidden"},key:q},{title:z(()=>[kt(f(a.$t(`common.${s.name.toLowerCase().replace(/\s+/g,"")}`)),1)]),subtitle:z(()=>[kt(f(a.$t("common.price"))+" : "+f(s.price)+"€",1)]),content:z(()=>[u(w).customDishAPI.customDishes.value.find(_=>_.name==s.name)?(r(),d("div",Ea,[(r(!0),d(J,null,G(s.notesAndId,(_,ot)=>(r(),d("div",null,[s.notesAndId[ot].length!==0?(r(),d("span",Ra,f(B(s.name,ot,dt(s.name)))+": "+f(tt(s.notesAndId[ot],dt(s.name))),1)):k("",!0)]))),256)),n("div",null,[s.dishNote?(r(),d("span",Va,f(a.$t("common.note"))+": "+f(s.dishNote),1)):k("",!0)])])):k("",!0)]),footer:z(()=>[n("div",ja,[t.isTakeaway?k("",!0):(r(),Y(u(K),{key:0,label:u(c)("common.edit")+" "+u(c)("common.note"),severity:"contrast",onClick:_=>W(s)},null,8,["label","onClick"])),y(u(K),{label:u(c)("common.remove"),severity:"danger",onClick:_=>M(s)},null,8,["label","onClick"])])]),_:2},1024))),128)),(r(!0),d(J,null,G(i.value,(s,q)=>(r(),d("div",{key:q,class:"p-2 border-round shadow-1 transition-all transition-duration-200 hover:shadow-3 flex flex-column gap-1"},[n("div",Ma,[n("img",{src:s.image,alt:s.name,class:"w-4rem h-4rem border-round flex-shrink-0",onError:S,style:{"object-fit":"cover","min-width":"4rem"}},null,40,Fa),n("div",Ka,[n("div",Wa,[n("div",Ha,[n("span",Ua,f(m(s)),1)])]),n("div",Qa,[s.dis_price?(r(),d("span",Ja,"€"+f(s.dis_price),1)):k("",!0),!s.dis_price&&s.price>0?(r(),d("span",Xa,"€"+f(s.price),1)):k("",!0),s.price>0?(r(),d("span",Ya,"/uni.")):k("",!0)])])]),n("div",null,[s.dishNote?(r(),d("span",Ga,f(u(c)("common.note")+": "+s.dishNote),1)):k("",!0)]),n("div",Za,[n("div",ts,[t.isTakeaway?k("",!0):(r(),Y(u(K),{key:0,label:u(c)("common.edit")+" "+u(c)("common.note"),severity:"contrast",class:"w-3.5rem h-2rem",onClick:_=>W(s)},null,8,["label","onClick"]))]),n("div",es,[y(u(K),{icon:"pi pi-minus",rounded:"",disabled:s.quantity<=0,onClick:_=>st(q,-1),class:"w-2rem h-2rem"},null,8,["disabled","onClick"]),n("span",as,f(s.quantity),1),y(u(K),{icon:"pi pi-plus",rounded:"",disabled:x(s),onClick:_=>st(q,1),class:"w-2rem h-2rem"},null,8,["disabled","onClick"])])])]))),128))]),t.isTakeaway?k("",!0):(r(),d("div",ss,[y(u(Jt),{variant:"in"},{default:z(()=>[y(u(ne),{id:"in_label",modelValue:N.value,"onUpdate:modelValue":l[0]||(l[0]=s=>N.value=s),variant:"filled",maxlength:"20"},null,8,["modelValue"]),n("label",ns,f(u(c)("common.name")),1)]),_:1}),y(u(Jt),{variant:"in"},{default:z(()=>[y(u(Kt),{id:"in_label",class:"min-w-full",rows:"5",modelValue:Q.value,"onUpdate:modelValue":l[1]||(l[1]=s=>Q.value=s),variant:"filled",maxlength:"200"},null,8,["modelValue"]),n("label",os,f(u(c)("common.observation")),1)]),_:1})]))]),_:1},8,["visible","header"]),y(u($t),{visible:V.value,"onUpdate:visible":l[6]||(l[6]=s=>V.value=s),header:u(c)("common.note"),onHide:l[7]||(l[7]=s=>C()),modal:"",dismissableMask:!0},{default:z(()=>[y(u(Kt),{modelValue:$.value,"onUpdate:modelValue":l[3]||(l[3]=s=>$.value=s),rows:"5",cols:"30",placeholder:u(c)("common.edit")+" "+u(c)("common.note")+"...",maxlength:"100"},null,8,["modelValue","placeholder"]),n("div",us,[y(u(K),{label:u(c)("common.cancel"),severity:"danger",onClick:l[4]||(l[4]=s=>P(!1))},null,8,["label"]),y(u(K),{label:u(c)("common.save"),severity:"primary",size:"sm",onClick:l[5]||(l[5]=s=>P(!0))},null,8,["label"])])]),_:1},8,["visible","header"])],64))}},ds=Dt(cs,[["__scopeId","data-v-591e334d"]]);var ps=Lt`
    .p-overlaybadge {
        position: relative;
    }
